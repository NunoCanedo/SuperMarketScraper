...
def scrape_product_page(link, product_ID):
    ...
    #data = soup.select_one('#root > div.app > div.ln-o-page > div.ln-o-page__body > div > div > div > div > section:nth-child(1) > div > div')
...
#root > div.app > div.ln-o-page > div.ln-o-page__body > div > div > div > div > section:nth-child(2) > div > div > div.pd__right > h1
##root > div.app > div.ln-o-page > div.ln-o-page__body > div > div > div > div > section:nth-child(1) > div > div > div.pd__right > h1